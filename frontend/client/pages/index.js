          ...
          <Col xs lg={12}>
            <Row style={{ marginTop: 50 }} data-aos='fade-right'>
              <Col md={{ span: 5, offset: 3 }}>
                <span style={{ fontSize: 50, fontWeight: 'bold' }}>STEP 1</span>
                <br />
                <Tombol
                  variant='warning'
                  fontWeight='bold'
            ...
            <Row style={{ marginTop: 50 }} data-aos='fade-left'>
              <Col md={{ span: 5, offset: 6 }}>
                {' '}
                <span style={{ fontSize: 50, fontWeight: 'bold' }}>STEP 2</span>
                <br />
                <Tombol
                  variant='warning'
                  fontWeight='bold'
            ...
            >
              ...
              <Col md={6}>
                <div style={{ fontSize: 50, fontWeight: 'bold' }}>30+ Team</div>
                <img
            ...
            >
              <Col md={{ span: 5, offset: 4 }}>
                <div className='text-right'>
                  ...
                  <div style={{ fontSize: 50, fontWeight: 'bold' }}>STEP 3</div>
                  <Tombol
                    variant='warning'
                    fontWeight='bold'
                    borderRadius='2.5rem'
