...
router.get(
  ...
  awaitHandlerFactory(getAllUsers)
) // localhost:3000/api/v1/users GET ALL USER (ADMIN ONLY)
router.get(
  '/id/:id',
  auth(Role.SuperAdmin, Role.Admin),
  awaitHandlerFactory(getUserById)
) // localhost:3000/api/v1/users/id/1 GET USER BY ID
// router.get(
//   '/nickname/:nickname',
//   auth(),
